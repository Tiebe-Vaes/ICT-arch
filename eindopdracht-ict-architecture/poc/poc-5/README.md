...
In de daadwerkelijke modulaire monoliet zouden `BookingComAdapter` en de facade
leven binnen het `module-external-integration`-pakket en direct aangeroepen worden door andere
